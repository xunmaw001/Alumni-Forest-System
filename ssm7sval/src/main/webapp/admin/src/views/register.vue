  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">校友林微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">年级专业</div>
			   <div class="input-container">
			     <input v-model="ruleForm.nianjizhuanye" class="input" type="text" placeholder="年级专业">
			   </div>
			 </div> -->
			<el-form-item label="年级专业" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.nianjizhuanye" autocomplete="off" placeholder="年级专业"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
