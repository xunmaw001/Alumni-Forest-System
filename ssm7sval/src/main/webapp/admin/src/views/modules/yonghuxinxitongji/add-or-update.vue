<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="认养树木编号" prop="renyangshumubianhao">
          <el-input v-model="ruleForm.renyangshumubianhao" 
              placeholder="认养树木编号" clearable  :readonly="ro.renyangshumubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="认养树木编号" prop="renyangshumubianhao">
              <el-input v-model="ruleForm.renyangshumubianhao" 
                placeholder="认养树木编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐款总金额" prop="juankuanzongjine">
          <el-input v-model="ruleForm.juankuanzongjine" 
              placeholder="捐款总金额" clearable  :readonly="ro.juankuanzongjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐款总金额" prop="juankuanzongjine">
              <el-input v-model="ruleForm.juankuanzongjine" 
                placeholder="捐款总金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    zhanghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              if(data.data.nianjizhuanye){
                this.ruleForm.nianjizhuanye = data.data.nianjizhuanye
              }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yonghuxinxitongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yonghuxinxitongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
