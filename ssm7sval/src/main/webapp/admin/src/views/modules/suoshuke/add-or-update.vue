<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科" prop="ke">
          <el-input v-model="ruleForm.ke" 
              placeholder="科" clearable  :readonly="ro.ke"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科" prop="ke">
              <el-input v-model="ruleForm.ke" 
                placeholder="科" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `suoshuke/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.suoshukeCrossAddOrUpdateFlag = false;
                  this.parent.search();
